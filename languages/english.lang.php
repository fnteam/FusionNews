 ...
 * @version $Id: english.lang.php 393 2012-02-10 22:37:14Z xycaleth $
 *
...
//$  Index.php  $
//°*************°
    'ind0' => "Welcome to Fusion News. Please log in.",
...
<td>&nbsp;- manage comments, word filter or uploads</td>
    ...
    'ind13' => '<table style="margin:0px auto 0px auto; border-width:0px">
	<tr>
...
// %s is replaced by the user's name.
    ...
    'ind24' => '<p><a href="javascript:toggleView(\'masks_1\');">Show/Hide Text Masks</a></p>
...
<table class="adminpanel">
    ...
    'ind25' => '<h2>Full News Template</h2>
...
<table class="adminpanel">
    ...
    'ind26' => '<p><a href="javascript:toggleView(\'masks_1\');">Show/Hide Text Masks</a></p>
<div id="masks_1" style="display:none">
<table class="adminpanel">
    ...
    'ind30' => '<p><a href="javascript:toggleView(\'masks_1\');">Show/Hide Text Masks</a></p>
<div id="masks_1" style="display:none">
<table class="adminpanel">
	<tr><td>{post_id}</td><td>Displays the ID number of the post.</td></tr>
    ...
    'ind30a' => '<p><a href="javascript:toggleView(\'masks_1\');">Show/Hide Text Masks</a></p>
<div id="masks_1" style="display:none">
<table class="adminpanel">
    ...
    'ind35' => 'Subject',
    'ind36' => 'Save Settings',
    'ind37' => '<h2>Comment Form Template</h2>
<p><a href="javascript:toggleView(\'masks_2\');">Show/Hide Text Masks</a></p>
<div id="masks_2" style="display:none">
<table class="adminpanel">
	<tr><td>{post_id}</td><td>Displays the ID number of the post.</td></tr>
    ...
    'ind38' => '<h2>Send to Friend Template</h2>
<p><a href="javascript:toggleView(\'masks_2\');">Show/Hide Text Masks</a></p>
<div id="masks_2" style="display:none">
<table class="adminpanel">
	<tr><td>{post_id}</td><td>Displays the ID number of the post.</td></tr>
    ...
    'ind44a' => 'Uncheck All',
    'ind45' => 'URL Settings',
    'ind46' => 'Ensure these settings are correct. Incorrect settings may cause Fusion News to be unusable.',
    'ind47' => 'Website URL',
    'ind48' => 'Example: http://www.yourdomain.com',
    'ind49' => 'Fusion News URL',
    ...
    'ind56' => 'Date Format',
    'ind57' => 'Default News Display Settings',
    'ind58' => 'Number of news posts to display per page',
    'ind59' => 'Default News Pagination Settings',
    'ind60' => 'Number of headlines to display',
    'ind61' => 'Default Headline Display Settings',
    'ind62' => 'Allow BBCode',
    'ind63' => 'Allow HTML',
    'ind64' => 'Allow Smilies',
...
//END - admin section
    ...
    'ind104' => 'Viewing News',
    'ind105' => 'The server has disabled file uploading. Fusion News has disabled the image upload feature automatically.',
    'ind106' => 'Upload Settings',
    'ind107' => 'log out',
    'ind108' => 'new post',
    'ind109' => 'edit posts',
    'ind110' => 'Add',
...
// %d will be replaced by the category ID.
    ...
    'ind216' => 'Control Panel Settings',
    'ind217' => 'Current Password',
    'ind218' => 'New Password',
    'ind219' => 'Number of hours to add or subtract from the server time, to get the time a new post was made.',
    ...
    'ind225' => 'Leave blank to keep your current password.',
    'ind226' => 'File Name',
    'ind227' => 'Size',
...
//in the sense of: 'Love.jpg succesfully uploaded'
    ...
    'ind258' => 'Description',
    'ind259' => 'Return to previous page',
    ...
    'ind267' => 'Link headlines to full story',
    'ind268' => 'Comment Display Settings',
    ...
    'ind290' => 'Posts not shown by news.php will be automatically linked to the full story.',
    'ind291' => 'Time Posted',
    ...
    'ind300' => 'There are no uploaded images.',
    'ind301' => 'The smiley image chosen does not exist.',
    'ind302' => 'Configuration',
    'ind303' => 'Your version of Fusion News (' . FNEWS_VERSION . ') is currently out-of-date. Please visit the Fusion News website to download the latest version.',
    'ind304' => 'Your version of Fusion News (' . FNEWS_VERSION . ') is currently up-to-date!',
    'ind305' => 'RSS Title',
...
// %s is replaced by the category name.
    ...
    'ind348' => '<p>The news template, can be changed by going to the <b>Manage Templates</b> page, in the admin panel. On this page, select the <b>Short and Full News Templates</b> option from the drop down menu. The first text box is for the short news, the second text box is for the full news.</p>',
    'ind349' => 'Can the number of displayed news posts be changed?',
    'ind350' => '<p>Yes - go to the <b>News Post Settings</b> page in the admin panel. Under the <b>Number of news posts to display per page</b> heading, change the number in the first text box to the number of posts to be shown.</p>',
...
// %d replaced by the number of unvalidated comments
    ...
    'ind410' => 'Ascending',
    'ind411' => 'Descending',
    'ind412' => 'User "%s" was deleted.',
    'ind413' => 'User Deleted',
    'ind414' => 'Repair News Database',
    'ind415' => 'System could not scan the news/ directory for files.',
    'ind416' => 'The news database has been resynchronized successfully.',
    'ind417' => 'Post Deleted',
    'ind418' => 'The news post was deleted successfully.',
    'ind419' => 'The comment was deleted successfully.',
    'ind420' => 'Comment Deleted',
    'ind421' => 'One or more of the find fields have an invalid regex expression.',
...
//$lang['com4'] and $lang['com5'] are one sentence they become ex. ...last 60 seconds...
