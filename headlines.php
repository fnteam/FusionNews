 ...
 * @version $Id: headlines.php 391 2011-10-25 20:14:52Z xycaleth $
 *
...
global $numofh, $link_headline_fullstory, $flip_news, $fsnw, $wfpost,
...
if ( !isset ($fn_news_url) )
{
    ...
    unset ($fn_news_url, $fn_category, $fn_num_headlines, $fn_static);
	return;
}
